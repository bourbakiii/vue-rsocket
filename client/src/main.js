...
import {MESSAGE_RSOCKET_MIMETYPE} from "rsocket-core/build";
...
const store = createStore({
    ...
    actions: {
        ...
        loadInts(context) {
            ...
            rsocket
                .requestStream({data: '1', metadata:  encodeCompositeMetadata([
                    [MESSAGE_RSOCKET_ROUTING, encodeRoute('some.channel')],
                  ]) })
                .subscribe({
                    onNext: (msg) => {
